...
def process_data(data):
  ...
  most_popular = {"year": 0, "sales": max(year_sales.values())}
  for year in year_sales.keys():
    if most_popular["sales"] == year_sales[year]:
      most_popular["year"] = year
  ...
  summary = [
    ...
    "The most popular year was {} with {} sales.".format(
      most_popular["year"], most_popular["sales"])
  ]
